...
function downloadPrivateKey() {
    var dataPtr = Module._get_private_key();
    var dataLength = Module._get_private_key_length(); 
    var dataString = readBinaryData(dataPtr,dataLength);

    // Convert the data string to a Blob
    var blob = new Blob([dataString], { type: 'application/octet-stream' });
